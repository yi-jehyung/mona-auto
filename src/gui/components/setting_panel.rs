...
fn show_select_input_type(ui: &mut Ui, app: &mut MyApp) {
    ...
    ComboBox::new("input_type", fl!(app.i18n_loader, "setting-panel-label-input-type"))
        .selected_text(text)
        .show_ui(ui, |ui| {
            if ui
...
fn show_select_capture_type(ui: &mut Ui, app: &mut MyApp) {
    ...
    ComboBox::new("capture_type", fl!(app.i18n_loader, "setting-panel-label-capture-type"))
        .selected_text(text)
        .show_ui(ui, |ui| {
            if ui
...
fn show_select_loop_speed(ui: &mut Ui, app: &mut MyApp) {
    let text = match app.setting.loop_per_second {
        per if per <= 5 => fl!(app.i18n_loader, "setting-panel-loop-per-second-very-low"),
        per if per <= 10 => fl!(app.i18n_loader, "setting-panel-loop-per-second-low"),
        per if per <= 20 => fl!(app.i18n_loader, "setting-panel-loop-per-second-medium"),
        per if per <= 30 => fl!(app.i18n_loader, "setting-panel-loop-per-second-high"),
        _ => fl!(app.i18n_loader, "setting-panel-loop-per-second-very-high"),
    };
    ComboBox::new("loop_per_second", fl!(app.i18n_loader, "setting-panel-label-loop-per-second"))
        .selected_text(text)
        .show_ui(ui, |ui| {
            if ui
                .selectable_value(
                    &mut app.setting.loop_per_second,
                    5,
                    fl!(app.i18n_loader, "setting-panel-loop-per-second-very-low"),
                )
                .clicked()
            {
            ...
            if ui
                .selectable_value(
                    &mut app.setting.loop_per_second,
                    10,
                    fl!(app.i18n_loader, "setting-panel-loop-per-second-low"),
                )
                .clicked()
            {
            ...
            if ui
                .selectable_value(
                    &mut app.setting.loop_per_second,
                    15,
                    fl!(app.i18n_loader, "setting-panel-loop-per-second-medium"),
                )
                .clicked()
            {
            ...
            if ui
                .selectable_value(
                    &mut app.setting.loop_per_second,
                    25,
                    fl!(app.i18n_loader, "setting-panel-loop-per-second-high"),
                )
                .clicked()
            {
            ...
            if ui
                .selectable_value(
                    &mut app.setting.loop_per_second,
                    60,
                    fl!(app.i18n_loader, "setting-panel-loop-per-second-very-high"),
                )
                .clicked()
            {
